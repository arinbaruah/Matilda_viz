...
df_drug_deaths <- tibble(drug = c("Tobacco","Alcohol use (Indirect)","Illicit drugs","Alcohol use (Direct)"),
...
ggplot(data = titanic_data,
  ...
  scale_x_discrete(limits = c("Class", "Sex", "Age"), expand = c(0.15, 0.05)) +
  labs(title = "Survival of Titanic Passengers by Class, Sex, and Age",
       x = "Demographics",
       y = "Frequency") +
  theme_minimal()
```
...
df_overdose_long$drug_type_clean <- factor(df_overdose_long$drug_type_clean,levels = c("Prescription Opioids","Heroin",
